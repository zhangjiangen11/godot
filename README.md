...
调试版windows编辑器命令： scons p=windows vsproj=yes use_assertions=yes dev_build=yes debug_symbols=yes vsproj_gen_only=no d3d12=yes werror=yes warnings=extra profiler_path="../../thirdparty/tracy" profiler=tracy
