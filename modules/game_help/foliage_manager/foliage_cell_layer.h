...
public:
	...
	MemoryPool::Block *add_cell(Vector3 &map_offset_pos, FoliageCellAsset::CellData *_cell, MemoryPoolData<PendingProtoBox> &memoryPoolData, HashMap<String, Ref<FoliagePrototype>> &prototypes) {
