...
struct FoliageCellGpuInstanceLoadBuffer {
	...
	void AddLoadInfo(FoliageCellAsset::CellData &info, MemoryPool::Block *dest_point, const Vector3 &mapOffset, const AABB &boxOS, const Vector2i &instanceRange);
