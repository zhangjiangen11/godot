...
HashMap<String, String> HandBones = {
	{ "Left Thumb Proximal", "left" },
	{ "Left Thumb Intermediate", "left" },
	{ "Left Thumb Distal", "left" },
	{ "Left Index Proximal", "left" },
	{ "Left Index Intermediate", "left" },
	{ "Left Index Distal", "left" },
	{ "Left Middle Proximal", "left" },
	{ "Left Middle Intermediate", "left" },
	{ "Left Middle Distal", "left" },
	{ "Left Ring Proximal", "left" },
	{ "Left Ring Intermediate", "left" },
	{ "Left Ring Distal", "left" },
	{ "Left Little Proximal", "left" },
	{ "Left Little Intermediate", "left" },
	{ "Left Little Distal", "left" },
	{ "Right Thumb Proximal", "right" },
	{ "Right Thumb Intermediate", "right" },
	{ "Right Thumb Distal", "right" },
	{ "Right Index Proximal", "right" },
	{ "Right Index Intermediate", "right" },
	{ "Right Index Distal", "right" },
	{ "Right Middle Proximal", "right" },
	{ "Right Middle Intermediate", "right" },
	{ "Right Middle Distal", "right" },
	{ "Right Ring Proximal", "right" },
	{ "Right Ring Intermediate", "right" },
	{ "Right Ring Distal", "right" },
	{ "Right Little Proximal", "right" },
	{ "Right Little Intermediate", "right" },
	{ "Right Little Distal", "right" },
};
...
LocalVector<HumanBodyBones> boneIndexToMono = {
	// HumanTrait.GetBoneIndexToMono(internal)
	HumanBodyBones::Hips,
...
LocalVector<int8_t> boneIndexToParent = {
	// HumanTrait.GetBoneIndexToMono(internal)
...
public:
	...
	Variant next(float timestep = -1.0) {
		...
		if (results.size() == 3) {
			...
			if (valid_components == 0) { //pass # push_error("next() called when all sub-tracks are eof or null")
