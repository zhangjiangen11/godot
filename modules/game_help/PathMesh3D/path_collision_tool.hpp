...
#define PATH_COLLISION_TOOL_IMPLEMENTATION(m_class, m_super, m_bake_name)                                                                                \
	...
	void m_class::_bind_methods() {                                                                                                                      \
		...
		ADD_PROPERTY(PropertyInfo(Variant::INT, "rotation_mode", PROPERTY_HINT_ENUM, "Fixed,Path"), "set_mesh_rotation_mode", "get_mesh_rotation_mode"); \
                                                                                                                                                         \
		...
		ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "mesh_rotation"), "set_mesh_rotation", "get_mesh_rotation");                                         \
                                                                                                                                                         \
