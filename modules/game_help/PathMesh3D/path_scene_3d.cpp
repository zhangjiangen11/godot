...
void PathScene3D::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_mesh_rotation_mode", "rotation_mode"), &PathScene3D::set_rotation_mode);
	ClassDB::bind_method(D_METHOD("get_mesh_rotation_mode"), &PathScene3D::get_rotation_mode);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "rotation_mode", PROPERTY_HINT_ENUM, "Fixed,Path,Random"), "set_mesh_rotation_mode", "get_mesh_rotation_mode");
