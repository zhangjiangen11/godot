...
def write_math_constants():
    ...
    write_math_constant("PI", "Math::PI")
    write_math_constant("PI/2", "Math::PI * 0.5")
    write_math_constant("LN(2)", "Math::LN2")
    write_math_constant("TAU", "Math::TAU")
    write_math_constant("E", "Math::E")
    write_math_constant("Sqrt1/2", "Math::SQRT12")
    write_math_constant("Sqrt2", "Math::SQRT2")
    write_math_constant("INF", "Math::INF")
    write_math_constant("NAN", "Math::NAN")
    indent_pop()
