...
namespace PropertyUtils
{
    ...
    {
        return p_left.type == p_right.type && p_left.hint == p_right.hint && p_left.hint_string == p_right.hint_string
               && p_left.usage == p_right.usage && p_left.class_name == p_right.class_name;
    }
    ...
    {
        return { Variant::INT, p_name, PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT | PROPERTY_USAGE_CLASS_IS_ENUM,
                 p_class_name };
    }
