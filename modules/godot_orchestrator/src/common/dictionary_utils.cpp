...
namespace DictionaryUtils
{
    ...
    {
        return p_left.name == p_right.name && p_left.type == p_right.type && p_left.hint == p_right.hint
               && p_left.class_name == p_right.class_name && p_left.hint_string == p_right.hint_string
    ...
    Dictionary from_method(const MethodInfo& p_method, bool p_use_minimal)
    {
        ...
        if (!p_use_minimal || !p_method.default_arguments.is_empty())
        {
            Array default_args;
        ...
        if (!p_use_minimal || !p_method.arguments.is_empty())
        {
            Array args;
