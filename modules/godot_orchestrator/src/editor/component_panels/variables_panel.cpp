...
void OrchestratorScriptVariablesComponentPanel::_create_variable_item(TreeItem* p_parent,
                                                                      const Ref<OScriptVariable>& p_variable)
{
    ...
    TreeItem* item = _create_item(category, p_variable->get_variable_name(), p_variable->get_variable_name(),
                                  "MemberProperty");
...
void OrchestratorScriptVariablesComponentPanel::_handle_button_clicked(TreeItem* p_item, int p_column, int p_id,
                                                                       int p_mouse_button)
{
    Ref<OScriptVariable> variable = _orchestration->get_variable(_get_tree_item_name(p_item));
    ...
    {
        // Type clicked
        Ref<OrchestratorEditorInspectorPluginVariable> plugin
