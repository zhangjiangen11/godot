...
TreeItem* OrchestratorEditorSearchDialog::_populate_search_results()
{
    ...
    {
        if (search_text.is_empty() || search_text.is_subsequence_ofn(item->name)
            || search_text.is_subsequence_ofn(item->text))
        {
...
Ref<OrchestratorEditorSearchDialog::SearchItem> OrchestratorEditorSearchDialog::_get_search_item_by_name(
...
void OrchestratorEditorSearchDialog::popup_create(bool p_dont_clear, bool p_replace_mode, const String& p_current_type,
