...
void OrchestratorPropertyInfoContainerEditorProperty::_show_type_selection(int p_index, const String& p_value)
{
    ...
    _dialog->connect(
        "selected",
        callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_argument_type_selected).bind(p_index));
...
void OrchestratorPropertyInfoContainerEditorProperty::_notification(int p_what)
{
    ...
    if (p_what == NOTIFICATION_READY)
    {
        ...
        _add_button->connect("pressed",
                             callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_add_property));
...
void OrchestratorPropertyInfoContainerEditorProperty::_update_property()
{
    ...
    for (int index = 0; index < _properties.size(); ++index)
    {
        ...
        if (index >= _slots.size())
        {
            ...
            new_slot.name->connect(
                "text_changed",
                callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_rename_property).bind(index));
            ...
            new_slot.type->connect(
                "pressed", callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_show_type_selection)
                               .bind(index, friendly_type_name));
            ...
            remove->connect(
                "pressed",
                callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_remove_property).bind(index));
            ...
            move_up->set_disabled(true);
            move_up->connect("pressed",
                             callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_move_up).bind(index));
            ...
            move_down->set_disabled(true);
            move_down->connect(
                "pressed", callable_mp(this, &OrchestratorPropertyInfoContainerEditorProperty::_move_down).bind(index));
