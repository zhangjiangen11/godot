...
OrchestratorGraphNodePin* OrchestratorGraphNodePinFactory::_resolve_string_based_pin(OrchestratorGraphNode* p_node,
                                                                                     const Ref<OScriptNodePin>& p_pin)
{
    static PackedStringArray input_event_names = Array::make("is_action_pressed", "is_action_released", "is_action",
                                                             "get_action_strength");

    static PackedStringArray input_names = Array::make("action_press", "action_release", "get_action_raw_strength",
                                                       "get_action_strength", "is_action_just_pressed",
...
OrchestratorGraphNodePin* OrchestratorGraphNodePinFactory::create_pin(OrchestratorGraphNode* p_node,
                                                                      const Ref<OScriptNodePin>& p_pin)
{
