...
void OrchestratorGraphNodePinFile::_on_show_file_dialog(Button* p_button)
{
    ...
    dialog->connect("file_selected",
                    callable_mp(this, &OrchestratorGraphNodePinFile::_on_file_selected).bind(dialog, p_button));
    dialog->connect("canceled",
                    callable_mp(this, &OrchestratorGraphNodePinFile::_on_file_canceled).bind(dialog, p_button));
...
Control* OrchestratorGraphNodePinFile::_get_default_value_widget()
{
    ...
    file_button->connect("pressed",
                         callable_mp(this, &OrchestratorGraphNodePinFile::_on_show_file_dialog).bind(file_button));
