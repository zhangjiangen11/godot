...
OrchestratorGraphNodePinStruct::OrchestratorGraphNodePinStruct(OrchestratorGraphNode* p_node,
...
void OrchestratorGraphNodePinStruct::_set_ui_value_by_property_path(const String& p_path, int p_index,
...
Control* OrchestratorGraphNodePinStruct::_get_default_value_widget()
{
    ...
    for (int i = 0; i < property_paths.size(); i++)
    {
        ...
        line_edit->connect("focus_entered",
                           callable_mp(this, &OrchestratorGraphNodePinStruct::_on_focus_entered).bind(i));
