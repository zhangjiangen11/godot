...
Control* OrchestratorGraphNodePinNodePath::_get_default_value_widget()
{
    ...
    _reset_button->connect("pressed", callable_mp_lambda(this, [=, this]() {
                               _reset();
                           }));
...
void OrchestratorGraphNodePinNodePath::_show_property_dialog()
{
    ...
    if (!target.is_valid() || !target->has_target())
    {
        ...
        if (self)
        {
            ...
            accept->connect("canceled", callable_mp_lambda(this, [&] {
                                accept->queue_free();
                            }));
            accept->connect("confirmed", callable_mp_lambda(this, [&] {
                                accept->queue_free();
                            }));
...
OrchestratorGraphNodePinNodePath::OrchestratorGraphNodePinNodePath(OrchestratorGraphNode* p_node,
