...
void OrchestratorGraphNodePin::_promote_as_variable()
{
    ...
    if (is_input())
    {
        ...
        get_graph()->spawn_node<OScriptNodeVariableGet>(
            context, position, callable_mp_lambda(this, [&, this](const Ref<OScriptNodeVariableGet>& p_node) {
    ...
    else
    {
        ...
        get_graph()->spawn_node<OScriptNodeVariableSet>(
            context, position, callable_mp_lambda(this, [&, this](const Ref<OScriptNodeVariableSet>& p_node) {
