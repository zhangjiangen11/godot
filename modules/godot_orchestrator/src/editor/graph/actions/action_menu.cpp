...
void OrchestratorGraphActionMenu::_notification(int p_what)
{
    if (p_what == NOTIFICATION_READY)
    {
        ...
        _close_on_focus_lost->connect("toggled",
                                      callable_mp(this, &OrchestratorGraphActionMenu::_on_toggle_close_on_focus_lost));
        ...
        _filters_text_box->connect("text_changed",
                                   callable_mp(this, &OrchestratorGraphActionMenu::_on_filter_text_changed));
        _filters_text_box->connect("text_submitted",
                                   callable_mp(this, &OrchestratorGraphActionMenu::_on_filter_text_changed));
        _filters_text_box->connect("gui_input",
                                   callable_mp(this, &OrchestratorGraphActionMenu::_on_filter_text_gui_input));
        ...
        _context_sensitive->connect("toggled",
                                    callable_mp(this, &OrchestratorGraphActionMenu::_on_context_sensitive_toggled));
        ...
        _tree_view->connect("nothing_selected",
                            callable_mp(this, &OrchestratorGraphActionMenu::_on_tree_nothing_selected));
        ...
        ProjectSettings::get_singleton()->connect("settings_changed",
                                                  callable_mp(this, &OrchestratorGraphActionMenu::clear));
    }
}
...
TreeItem* OrchestratorGraphActionMenu::_make_item(TreeItem* p_parent,
                                                  ...
                                                  const String& p_text, bool p_favorite_icon, bool p_is_favorite)
{
    ...
    if (!p_menu_item->get_spec().type_icon.is_empty())
    {
        ...
        child->set_button_tooltip_text(
            2, 0, p_menu_item->get_handler().is_valid() ? p_menu_item->get_handler()->get_class() : "");
    }
    ...
    if (p_favorite_icon && p_menu_item->get_handler().is_valid())
    {
        ...
        child->set_button_tooltip_text(2, 1,
                                       p_is_favorite ? "Remove action from favorites." : "Add action to favorites.");
