...
public:
    ...
    virtual bool is_filtered(const OrchestratorGraphActionFilter& p_filter, const OrchestratorGraphActionSpec& p_spec)
    {
        return false;
    }
};
...
public:
    ...
    OrchestratorGraphActionMenuItem(const OrchestratorGraphActionSpec& p_spec,
                                    Ref<OrchestratorGraphActionHandler>& p_handler)
        : _spec(p_spec)
        , _handler(p_handler)
    {
    }
...
{
    _FORCE_INLINE_ bool operator()(const Ref<OrchestratorGraphActionMenuItem>& a,
                                   const Ref<OrchestratorGraphActionMenuItem>& b) const
    {
