...
protected:
    ...
    Vector<Ref<SearchItem>> _get_class_hierarchy_search_items(
        const String& p_class, HashMap<String, Ref<SearchItem>>& r_cache, const Ref<SearchItem>& p_root);

public:
    //~ Begin OrchestratorEditorSearchDialog Interface
    void popup_create(bool p_dont_clear, bool p_replace_mode, const String& p_current_type,
                      const String& p_current_name) override;
    //~ End OrchestratorEditorSearchDialog Interface
