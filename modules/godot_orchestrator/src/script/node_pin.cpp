...
// Binds the EPinDirection and Flags enums so that they can be used in GDScript.
void OScriptNodePin::_bind_methods(){
    BIND_ENUM_CONSTANT(EPinDirection::PD_Input) BIND_ENUM_CONSTANT(EPinDirection::PD_Output)
        BIND_ENUM_CONSTANT(EPinDirection::PD_MAX)

            BIND_ENUM_CONSTANT(Flags::NONE) BIND_ENUM_CONSTANT(Flags::DATA) BIND_ENUM_CONSTANT(Flags::EXECUTION)
                BIND_ENUM_CONSTANT(Flags::IGNORE_DEFAULT) BIND_ENUM_CONSTANT(Flags::READ_ONLY)
                    BIND_ENUM_CONSTANT(Flags::HIDDEN) BIND_ENUM_CONSTANT(Flags::ORPHANED)
                        BIND_ENUM_CONSTANT(Flags::ADVANCED) BIND_ENUM_CONSTANT(Flags::NO_CONNECTION)
                            BIND_ENUM_CONSTANT(Flags::SHOW_LABEL) BIND_ENUM_CONSTANT(Flags::HIDE_LABEL)
                                BIND_ENUM_CONSTANT(Flags::CONST) BIND_ENUM_CONSTANT(Flags::REFERENCE)
                                    BIND_ENUM_CONSTANT(Flags::OBJECT) BIND_ENUM_CONSTANT(Flags::FILE)
                                        BIND_ENUM_CONSTANT(Flags::MULTILINE) BIND_ENUM_CONSTANT(Flags::ENUM)
}
...
bool OScriptNodePin::can_accept(const Ref<OScriptNodePin>& p_pin) const
{
    ...
    if (_property.type == p_pin->get_type())
    {
        ...
        else if (target_class.is_empty() && !source_class.is_empty())
        {
            ...
            if (!PropertyUtils::is_class_enum(p_pin->get_property_info())
                && !PropertyUtils::is_class_bitfield(p_pin->get_property_info()))
                return false;
        }
