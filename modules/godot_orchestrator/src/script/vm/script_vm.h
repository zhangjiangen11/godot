...
protected:
    ...
    void _get_execution_path(Orchestration* p_orchestration, int p_node_id, RBSet<OScriptConnection>& r_connections,
                             RBSet<int>& r_execution_path);

    /// Capture the data connection lookup
    /// @param p_orchestration the orchestration
    /// @param r_lookup the lookup map
    void _get_data_connection_lookup(Orchestration* p_orchestration,
    ...
    bool _create_node_instance(Orchestration* p_orchestration, int p_node_id, Function& r_function,
    ...
    bool _build_function_node_graph(const Ref<OScriptFunction>& p_function, Function& r_function,
                                    HashMap<String, int>& r_lv_indices);
    ...
    void _dependency_step(OScriptExecutionContext& p_context, OScriptNodeInstance* p_instance,
    ...
    OScriptNodeInstance* _resolve_next_node(OScriptExecutionContext& p_context, OScriptNodeInstance* p_instance,
                                            int p_result, int p_next_node_id);
    ...
    void _set_node_flow_execution_state(OScriptExecutionContext& p_context, OScriptNodeInstance* p_instance,
                                        int p_result);
    ...
    void _call_method_internal(const StringName& p_method, OScriptExecutionContext* p_context, bool p_resume,
                               OScriptNodeInstance* p_instance, Function* p_function, Variant& r_return,
...
public:
    ...
    void call_method(OScriptInstance* p_instance, const StringName& p_method, const Variant* const* p_args,
