...
Ref<OScriptNodePin> OScriptNode::create_pin(EPinDirection p_direction, EPinType p_pin_type,
                                            const PropertyInfo& p_property, const Variant& p_default_value)
{
