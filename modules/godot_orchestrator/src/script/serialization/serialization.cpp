...
Variant OScriptBinaryResourceLoader::_load(const String& p_path, const String& p_original_path, bool p_use_threads,
...
Variant OScriptTextResourceLoader::_load(const String& p_path, const String& p_original_path, bool p_use_threads,
                                         int32_t p_cache_mode) const
{
