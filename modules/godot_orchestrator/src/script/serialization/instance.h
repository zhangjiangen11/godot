...
{
protected:
    String _create_start_tag(const String& p_resource_class, const String& p_script_class, uint32_t p_load_steps,
                             uint32_t p_version, int64_t p_uid);
    String _create_ext_resource_tag(const String& p_type, const String& p_path, const String& p_id,
                                    bool p_newline = true);
};
