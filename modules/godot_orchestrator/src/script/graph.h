...
private:
    ...
    void _initialize_node(const Ref<OScriptNode>& p_node, const OScriptNodeInitContext& p_context,
...
public:
    ...
    Ref<OScriptNode> create_node(const StringName& p_type, const OScriptNodeInitContext& p_context,
