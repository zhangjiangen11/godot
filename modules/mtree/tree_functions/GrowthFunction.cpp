...
void GrowthFunction::_bind_methods() {
	ADD_SIMPLE_MEMBER_PROPERTY(int, iterations);
	ADD_SIMPLE_MEMBER_PROPERTY(float, apical_dominance);
	ADD_SIMPLE_MEMBER_PROPERTY(float, grow_threshold);
	ADD_SIMPLE_MEMBER_PROPERTY(float, split_angle);
	ADD_SIMPLE_MEMBER_PROPERTY(float, branch_length);
	ADD_SIMPLE_MEMBER_PROPERTY(float, gravitropism);
	ADD_SIMPLE_MEMBER_PROPERTY(float, randomness);
	ADD_SIMPLE_MEMBER_PROPERTY(float, cut_threshold);
	ADD_SIMPLE_MEMBER_PROPERTY(float, split_threshold);
	ADD_SIMPLE_MEMBER_PROPERTY(float, gravity_strength);

	ADD_SIMPLE_MEMBER_PROPERTY(float, apical_control);
	ADD_SIMPLE_MEMBER_PROPERTY(float, codominant_proba);
	ADD_SIMPLE_MEMBER_PROPERTY(int, codominant_count);
	ADD_SIMPLE_MEMBER_PROPERTY(float, branch_angle);
	ADD_SIMPLE_MEMBER_PROPERTY(float, philotaxis_angle);
	ADD_SIMPLE_MEMBER_PROPERTY(float, flower_threshold);

	ADD_SIMPLE_MEMBER_PROPERTY(float, growth_delta);
	ADD_SIMPLE_MEMBER_PROPERTY(float, flowering_delta);

	ADD_SIMPLE_MEMBER_PROPERTY(float, root_flux);
}
