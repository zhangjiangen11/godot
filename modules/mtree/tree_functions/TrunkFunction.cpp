...
void TrunkFunction::_bind_methods() {
	ADD_SIMPLE_MEMBER_PROPERTY(float, length);
	ADD_SIMPLE_MEMBER_PROPERTY(float, start_radius);
	ADD_SIMPLE_MEMBER_PROPERTY(float, end_radius);
	ADD_SIMPLE_MEMBER_PROPERTY(float, shape);
	ADD_SIMPLE_MEMBER_PROPERTY(float, resolution);
	ADD_SIMPLE_MEMBER_PROPERTY(float, randomness);
	ADD_SIMPLE_MEMBER_PROPERTY(float, up_attraction);
}
